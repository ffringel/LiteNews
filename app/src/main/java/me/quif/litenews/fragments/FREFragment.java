...
public class FREFragment extends ListFragment implements AbsListView.OnScrollListener {
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ListView mListView;
    private TweetTimelineListAdapter mListAdapter;
    private UserTimeline userTimeline;

    private String screenName = "France24_fr";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_fre, container, false);
