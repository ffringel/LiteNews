...
public class RecodeFragment extends ListFragment implements AbsListView.OnScrollListener{
    private TweetTimelineListAdapter mListAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ListView mListView;
    private UserTimeline userTimeline;

    private String screenName = "recode";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_recode, container, false);
