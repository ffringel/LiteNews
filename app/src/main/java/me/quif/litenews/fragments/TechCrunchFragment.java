...
public class TechCrunchFragment extends ListFragment implements AbsListView.OnScrollListener {
    private ListView mListView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private TweetTimelineListAdapter mListAdapter;
    private UserTimeline userTimeline;

    private String screenName = "techcrunch";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_tech_crunch, container, false);
