...
public class SkySportFragment extends ListFragment implements AbsListView.OnScrollListener {
    ...
    private String screenName = "skysports";
    private int mLastFirstVisibleItem;

    public SkySportFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_sky_sport, container, false);
