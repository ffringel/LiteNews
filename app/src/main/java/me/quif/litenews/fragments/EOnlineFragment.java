...
public class EOnlineFragment extends ListFragment implements AbsListView.OnScrollListener{
    private TweetTimelineListAdapter mListAdapter;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private ListView mListView;
    private UserTimeline userTimeline;

    private String screenName = "eonline";
    private int mLastFirstVisibleItem;

    public EOnlineFragment() {
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_eonline, container, false);
