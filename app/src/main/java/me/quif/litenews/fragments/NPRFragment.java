...
public class NPRFragment extends ListFragment implements AbsListView.OnScrollListener {
    private ListView mListView;
    private SwipeRefreshLayout mSwipeRefreshLayout;
    private TweetTimelineListAdapter mListAdapter;
    private UserTimeline userTimeline;

    private String screenName = "nprpolitics";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_npr, container, false);
