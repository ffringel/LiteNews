...
import me.quif.litenews.PoliticsPagerAdapter;
...
public class PoliticsActivity extends AppCompatActivity{
    PoliticsPagerAdapter viewPagerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerAdapter = new PoliticsPagerAdapter(getSupportFragmentManager(), Titles, numOfTabs);
    ...
    private void initActionMenu() {
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(PoliticsActivity.this, MainActivity.class);
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PoliticsActivity.this, SportActivity.class);
                startActivity(intent);
            }
        });
        ...
        button3.setLabelText("Technology");
        button3.setImageResource(R.drawable.ic_action_tech);
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PoliticsActivity.this, TechActivity.class);
                startActivity(intent);
            }
        });
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(PoliticsActivity.this, EntertainmentActivity.class);
                startActivity(intent);
            }
        });
