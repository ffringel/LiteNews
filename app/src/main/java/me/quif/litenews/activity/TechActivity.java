...
import me.quif.litenews.TechPagerAdapter;
import me.quif.litenews.view.widget.SlidingTabLayout;

public class TechActivity extends AppCompatActivity {
    TechPagerAdapter viewPagerAdapter;
    SlidingTabLayout tabs;
    int numOfTabs = 3;
    CharSequence Titles[] = {
            "TechCrunch", "Re/code", "Mashable"
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        viewPagerAdapter = new TechPagerAdapter(getSupportFragmentManager(), Titles, numOfTabs);
    ...
    private void initActionMenu() {
        ...
        button2.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TechActivity.this, SportActivity.class);
                startActivity(intent);
            }
        });
        ...
        button3.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TechActivity.this, PoliticsActivity.class);
                startActivity(intent);
            }
        });
        ...
        button4.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent intent = new Intent(TechActivity.this, EntertainmentActivity.class);
                startActivity(intent);
            }
        });
